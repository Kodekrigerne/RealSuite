...
namespace BusinessLogic
{
    public class PropertyService
    {
        ...
        public void ApplyFilters(string sold, int minPrice, int maxPrice, DateTime listedFrom, DateTime listedTo,
            string zipCode, string sellerID)
        {
        ...
        public bool VerifyProperty(PropertyDTO propertyDTO)
        {
            ...
            if (!propertyDTO.ZipCode.ToString().All(char.IsDigit) ||
                (propertyDTO.ZipCode < 1000 || propertyDTO.ZipCode > 9999)) return false;
            ...
            if (!Regex.IsMatch(propertyDTO.DateListed.ToString("yyyy-MM-dd"),
